    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IHttpClientFactory httpClientFactory, IConfiguration configuration)
        {
            ...
            _apiBaseUrl = configuration["ApiSettings:BaseUrl"]?? 
                throw new InvalidOperationException("API base URL ist nicht in der Konfiguration gesetzt (ApiSettings:BaseUrl)."); ;
        }
        ...
        public async Task<IActionResult> SetPassword(SetPasswordViewModel model)
        {
            ...
            var response = await _httpClient.PostAsJsonAsync(_apiBaseUrl+"/SetPassword", setPasswordData);
        ...
        public async Task<IActionResult> Create(CreateViewModel createViewModel)
        {
            ...
            var response = await _httpClient.PostAsJsonAsync(_apiBaseUrl + "/create", createData);
